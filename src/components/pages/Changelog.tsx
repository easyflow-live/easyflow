      ...
      <div className="text-white antialiased">
        ...
        <div className="mb-6">
          <p className="mb-2">
            ...
            improvements, bug fixes, other usability updates. Some changes may
            be omitted, such as changes that do not affect the user-facing
            experience.
          </p>
          <p className="mb-2">
        ...
        <LogCard>
          ...
          <LogList type={LogTypes.improvements}>
            {['Improved inputs contrast, making them lighter.'].map(
              (item, i) => (
                <LogListItem key={i}>{item}</LogListItem>
              )
            )}
